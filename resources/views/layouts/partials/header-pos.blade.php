    ...
    <div class="row">
        <div class="col-md-6">
            <div class="m-6 mt-5" style="display: flex;">
                ...
                @if(!empty($transaction->location_id)) {{$transaction->location->name}} @endif &nbsp; <span
        ...
        <div class="col-md-6">
            ...
            <button data-placement="bottom" data-toggle="tooltip" type="button" id="close_register"
            ...
            <button data-placement="bottom" data-toggle="tooltip" type="button" id="register_details"
            ...
            <button type="button" class="btn btn-danger btn-flat m-6 btn-xs m-5 pull-right" id="return_sale"
                title="@lang('lang_v1.sell_return')" data-toggle="popover"
            ...
            <button type="button" id="view_suspended_sales" title="{{ __('lang_v1.view_suspended_sales') }}"
                ...
                data-href="{{$view_suspended_sell_url}}" data-placement="bottom" data-toggle="tooltip">
            ...
            @endif
            @can('expense.add')
            <button type="button" data-placement="bottom" data-toggle="tooltip" title="{{ __('expense.add_expense') }}"
                data-placement="bottom" class="btn bg-purple btn-flat m-6 btn-xs m-5 btn-modal pull-right"
                id="add_expense">
